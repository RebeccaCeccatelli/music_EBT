#!/bin/bash
### Baseline HF GPT2 Transformer Music - Inference Script
### Generate MIDI music using HF GPT2 pretrained model
...
#SBATCH --output=logs/slurm/mus/baseline-hf-gpt2-mus-inference_%A-%a.log

### ADDITIONAL RUN INFO ###
#SBATCH --array=0

### LOG INFO ###
#SBATCH --job-name=baseline-hf-gpt2-mus-inference
export RUN_NAME="baseline-hf-gpt2-mus-inference"
...
--only_test \
--only_test_model_ckpt "logs/checkpoints/baseline-hf-gpt2-symb-small-0.0006_2026-04-28_12-00-00_/last.ckpt" \
