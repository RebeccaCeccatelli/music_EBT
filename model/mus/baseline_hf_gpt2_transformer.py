...
class Baseline_HF_GPT2_Transformer_MUS(L.LightningModule):
    ...
    def forward_loss_wrapper(self, batch, phase="train"):
        ...
        # Forward pass
        logits = self(ids, learning=True, return_raw_logits=True)
    ...
    def validation_step(self, batch, batch_idx):
        ...
        # Forward pass
        logits = self(ids, learning=False, return_raw_logits=True)
        ...
        accuracy = (pred_tokens[mask] == targets[mask]).float().mean()
