...
if __name__ == '__main__':
    ...
    parser.add_argument("--modality", help="is the model being trained for NLP, VID, IMG, MUS. default is VID, and most of the code has been designed around VID.", type=str, default="VID")
    ...
    # MUS SPECIFIC PARAMS ########################################################################################################################
    # TODO: add music specific params here when add music modality
    ...
    # MUS INFERENCE ########################################################################
    #TODO: add music specific inference params here when add music modality
